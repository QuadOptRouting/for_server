...
class Route_calculation_interface{
    virtual double calculate(std::pair<double, double> start, std::pair<double, double> finish) = 0;
    virtual std::vector<double> calculate_from_point_to_vector(std::pair<double, double> start, std::vector<std::pair<double, double>> finish) = 0;
    virtual std::vector<std::vector<double>> calculate_time_matrix(std::vector<std::pair<double, double>> start, std::vector<std::pair<double, double>> finish) = 0;
    virtual std::vector<double> calculate_time_vector(std::vector<std::pair<double, double>> start, std::vector<std::pair<double, double>> finish) = 0;
};
